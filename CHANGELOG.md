...
### Corrections
- Affichage des pièces restantes sur les cartes bourse dans les résultats du mode Play

## v3.8.2 (2026-01-04)

### Corrections
- Affichage des pièces restantes sur les cartes bourse dans le mode Scan
...
- IA Easy : comportement de débutant naïf
